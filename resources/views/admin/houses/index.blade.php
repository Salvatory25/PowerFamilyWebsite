...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#220325] p-6 rounded-2xl border border-[#4A0E4E]">
        ...
        <a href="{{ route('admin.houses.create') }}" class="bg-[#4A0E4E] hover:bg-[#68176E] text-white px-5 py-2.5 rounded-xl font-bold text-xs shadow border border-[#C59B27]/40 flex items-center space-x-2 transition">
                        ...
                        <tr class="hover:bg-[#320635]/60 transition">
                            <td class="px-6 py-4 flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <span class="text-[11px] text-[#DFB743]">{{ $house->house_reference }}</span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 text-right space-x-2">
                                <a href="{{ route('admin.houses.edit', $house->id) }}" class="px-3 py-1.5 rounded-lg bg-[#4A0E4E] text-white hover:bg-[#68176E] text-xs font-semibold">
                                    Hariri
                                </a>
