...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <!-- Total Plots -->
        <div class="bg-[#1C0305] rounded-2xl p-6 border border-[#750D15] shadow-sm relative overflow-hidden">
            <div class="flex items-center justify-between">
                <span class="text-xs font-bold text-gray-400 uppercase tracking-wider">Viwanja Vyote</span>
                <span class="p-2 rounded-xl bg-[#750D15] text-[#FAC955]">
    ...
    <!-- Quick Actions Bar -->
    <div class="bg-[#1C0305] p-6 rounded-2xl border border-[#750D15] flex flex-wrap items-center justify-between gap-4">
        <div>
        ...
        <div class="flex flex-wrap items-center gap-3">
            <a href="{{ route('admin.plots.create') }}" class="bg-[#750D15] hover:bg-[#961620] text-white px-4 py-2 rounded-xl text-xs font-bold transition border border-[#D48B16]/40 shadow">
                + Kiwanja Kipya
            </a>
            <a href="{{ route('admin.houses.create') }}" class="bg-[#750D15] hover:bg-[#961620] text-white px-4 py-2 rounded-xl text-xs font-bold transition border border-[#D48B16]/40 shadow">
                + Nyumba Mpya
            </a>
            <a href="{{ route('admin.vehicles.create') }}" class="bg-[#750D15] hover:bg-[#961620] text-white px-4 py-2 rounded-xl text-xs font-bold transition border border-[#D48B16]/40 shadow">
                + Gari Jipya
            </a>
            <a href="{{ route('admin.gallery.create') }}" class="bg-[#750D15] hover:bg-[#961620] text-white px-4 py-2 rounded-xl text-xs font-bold transition border border-[#D48B16]/40 shadow">
    ...
    <div class="bg-[#1C0305] rounded-2xl border border-[#750D15] overflow-hidden">
        <div class="p-6 border-b border-[#750D15] flex items-center justify-between">
            <h3 class="text-base font-bold text-white">Maulizo ya Hivi Karibuni (Recent Leads)</h3>
            <a href="{{ route('admin.enquiries.index') }}" class="text-xs font-bold text-[#FAC955] hover:underline">Tazama Yote &rarr;</a>
        </div>
                ...
                <tbody class="divide-y divide-[#750D15]">
                    @forelse($recentEnquiries as $inq)
                        <tr class="hover:bg-[#280508]/60 transition">
                            ...
                            <td class="px-6 py-4">
                                <span class="px-2.5 py-1 rounded-md text-[11px] font-bold uppercase bg-[#750D15] text-[#FAC955]">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('admin.enquiries.show', $inq->id) }}" class="px-3 py-1.5 rounded-lg bg-[#750D15] text-white hover:bg-[#961620] text-xs font-semibold transition">
                                    Tazama
                                </a>
                            </td>
                        </tr>
