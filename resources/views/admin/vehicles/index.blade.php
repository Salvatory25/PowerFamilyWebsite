...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#1C0305] p-6 rounded-2xl border border-[#750D15]">
        ...
        <a href="{{ route('admin.vehicles.create') }}" class="bg-[#750D15] hover:bg-[#961620] text-white px-5 py-2.5 rounded-xl font-bold text-xs shadow border border-[#D48B16]/40 flex items-center space-x-2 transition">
                        ...
                        <tr class="hover:bg-[#280508]/60 transition">
                            <td class="px-6 py-4 flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <span class="text-[11px] text-[#FAC955]">{{ $vehicle->vehicle_reference }}</span>
                                </div>
                            </td>
