...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data" class="bg-[#0c1c34] p-6 sm:p-8 rounded-3xl border border-[#16325c] space-y-6 shadow-xl">
        @csrf
        @method('PUT')

        <div class="space-y-4">
            <h3 class="text-xs font-extrabold uppercase tracking-wider text-[#c89a3b] border-b border-[#16325c] pb-2">
                1. Project Identity & Location
            </h3>

            <div>
                <label class="block text-xs font-bold text-slate-300 mb-1">Project Name *</label>
                <input type="text" name="name" value="{{ old('name', $project->name) }}" required class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:ring-2 focus:ring-[#c89a3b]">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="location_name" value="{{ old('location_name', $project->location_name) }}" required class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:ring-2 focus:ring-[#c89a3b]">
                ...
                <div>
                    ...
                    <input type="text" name="project_type" value="{{ old('project_type', $project->project_type) }}" required class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:ring-2 focus:ring-[#c89a3b]">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="short_description" value="{{ old('short_description', $project->short_description) }}" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:ring-2 focus:ring-[#c89a3b]">
            </div>

            <div>
                <label class="block text-xs font-bold text-slate-300 mb-1">Detailed Case Study Description *</label>
                <textarea name="description" rows="5" required class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:ring-2 focus:ring-[#c89a3b]">{{ old('description', $project->description) }}</textarea>
            ...
            <div>
                ...
                @endphp
                <input type="text" name="services_performed" value="{{ old('services_performed', $servicesStr) }}" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:ring-2 focus:ring-[#c89a3b]">
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <select name="project_status" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white focus:ring-2 focus:ring-[#c89a3b]">
                ...
                <div>
                    ...
                    <input type="text" name="size_covered" value="{{ old('size_covered', $project->size_covered) }}" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:ring-2 focus:ring-[#c89a3b]">
                </div>

                <div>
                    <label class="block text-xs font-bold text-slate-300 mb-1">Completion Date</label>
                    <input type="date" name="completion_date" value="{{ old('completion_date', $project->completion_date ? $project->completion_date->format('Y-m-d') : '') }}" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white focus:ring-2 focus:ring-[#c89a3b]">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="client_type" value="{{ old('client_type', $project->client_type) }}" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:ring-2 focus:ring-[#c89a3b]">
                </div>
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    @endif
                    <input type="file" name="featured_image" accept="image/*" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-xs text-slate-400 file:mr-3 file:py-1 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-[#16325c] file:text-white">
                </div>

                <div>
                    <label class="block text-xs font-bold text-slate-300 mb-1">Add More Gallery Photos</label>
                    <input type="file" name="images[]" multiple accept="image/*" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-xs text-slate-400 file:mr-3 file:py-1 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-[#16325c] file:text-white">
                </div>
            </div>
            ...
            <div class="flex items-center gap-6 pt-2">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $project->is_featured) ? 'checked' : '' }} class="w-4 h-4 rounded bg-slate-900 border-slate-700 text-[#c89a3b] focus:ring-0">
        ...
        <div class="pt-4 border-t border-[#16325c] flex items-center justify-end gap-3">
            ...
            <button type="submit" class="px-6 py-2.5 rounded-xl bg-[#c89a3b] hover:bg-[#b5882e] text-[#0c1c34] font-extrabold text-xs shadow-lg transition">
                Update Project
            </button>
        </div>
    </form>
