...
<div class="py-16 bg-neutral-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div class="bg-white rounded-2xl p-8 sm:p-12 shadow-sm border border-gray-100 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div class="space-y-4">
                <span class="text-xs font-extrabold text-[#D48B16] uppercase tracking-widest block">Dira Yetu & Utambulisho</span>
                <h2 class="text-2xl sm:text-3xl font-extrabold text-[#280508]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-3">
                <div class="w-12 h-12 rounded-xl bg-pfi-gradient flex items-center justify-center text-[#FAC955] shadow">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                </div>
                <h3 class="text-lg font-bold text-[#280508]">Dira Yetu (Vision)</h3>
            ...
            <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-3">
                ...
                <h3 class="text-lg font-bold text-[#280508]">Maadili Yetu (Core Values)</h3>
                <p class="text-xs text-gray-600 leading-relaxed">
        ...
        <div class="bg-pfi-gradient text-white rounded-2xl p-10 shadow-xl text-center space-y-4">
            ...
            <div class="pt-2">
                <a href="{{ route('pages.contact') }}" class="inline-block bg-gold-gradient text-[#1C0305] px-8 py-3.5 rounded-xl font-extrabold text-sm shadow hover:brightness-110 transition">
                    WASILIANA NASI LEO
                </a>
            </div>
        </div>
