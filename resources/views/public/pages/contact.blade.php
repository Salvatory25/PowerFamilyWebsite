        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div class="lg:col-span-5 space-y-6">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 space-y-6">
                    <h2 class="text-xl font-bold text-[#320635] border-b border-gray-100 pb-4">
                    ...
                    <div class="space-y-4 text-sm">
                        ...
                        <div class="flex items-start space-x-3">
                            <div class="w-10 h-10 rounded-xl bg-pfi-gradient flex items-center justify-center text-[#DFB743] shrink-0 shadow">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                            </div>
                            <div>
                                <span class="text-xs font-semibold text-gray-400 uppercase block">Simu ya Moja kwa Moja</span>
                                <a href="tel:{{ $phone }}" class="text-base font-bold text-gray-900 hover:text-[#4A0E4E] transition">{{ $phone }}</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:{{ $email }}" class="text-base font-bold text-gray-900 hover:text-[#4A0E4E] transition">{{ $email }}</a>
                            </div>
                        </div>
                    ...
                    <form action="{{ route('enquiry.submit') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#4A0E4E] focus:outline-none"
                            >
                        </div>
                        ...
                        <div>
                            ...
                            <select name="category" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-[#4A0E4E] focus:outline-none">
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#4A0E4E] focus:outline-none resize-none"
                            ></textarea>
                        </div>
