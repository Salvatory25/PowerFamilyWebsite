            ...
            @forelse($articles as $art)
                <div class="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col group card-hover-lift">
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between space-y-4">
                        <div>
                            <span class="text-[11px] font-bold text-[#D48B16] uppercase tracking-wider block mb-1">
                                {{ $art->category ?? 'Uwekezaji' }}
                            </span>
                            <h3 class="text-lg font-bold text-gray-900 line-clamp-2 group-hover:text-[#750D15] transition">
                                {{ $art->title }}
                            </h3>
                        ...
                        <div class="pt-3 border-t border-gray-100 flex items-center justify-between">
                            ...
                            <a href="{{ route('pages.article', $art->slug) }}" class="inline-flex items-center text-xs font-bold text-[#750D15] hover:text-[#D48B16] transition">
