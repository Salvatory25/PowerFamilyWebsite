...
<div class="py-12 bg-neutral-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-8">
            <form action="{{ route('houses.index') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select name="bedrooms" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#750D15] focus:outline-none">
        ...
        <div class="flex items-center justify-between mb-6 text-sm text-gray-600">
            <div>
                Inaonyesha <span class="font-bold text-[#750D15]">{{ $houses->total() }}</span> nyumba zilizopo
            </div>
                    ...
                    <div class="p-5 flex-1 flex flex-col justify-between space-y-4">
                        ...
                        <div class="pt-3 border-t border-gray-100 flex items-center justify-between">
                            <div>
                                ...
                                <span class="text-lg font-extrabold text-[#750D15]">{{ $house->formatted_price }}</span>
                            </div>
                            <a href="{{ route('houses.show', $house->slug) }}" class="bg-[#FDF5F6] group-hover:bg-pfi-gradient text-[#750D15] group-hover:text-white px-4 py-2 rounded-xl text-xs font-bold transition flex items-center space-x-1 shadow-sm border border-[#F9E4E7] group-hover:border-transparent">
