    ...
    <div class="bg-[#0c1c34] text-slate-300 text-xs py-2.5 px-4 border-b border-slate-800">
        <div class="w-full max-w-[1720px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
            ...
            <div class="flex items-center gap-6">
                <!-- Phone Direct Link -->
                <a href="tel:{{ $sitePhone ?? '+255742448965' }}" class="hidden sm:inline-flex items-center gap-1.5 text-slate-300 hover:text-white font-medium">
                ...
                <!-- Language Switcher -->
                <div class="flex items-center gap-1.5 font-medium bg-slate-900/60 px-2.5 py-1 rounded-lg border border-slate-800">
                    <span class="text-slate-400 text-[11px]">Lang:</span>
                    <a href="{{ route('lang.switch', 'en') }}" class="px-2 py-0.5 rounded transition text-xs {{ app()->getLocale() === 'en' ? 'bg-[#c89a3b] text-[#0c1c34] font-extrabold' : 'text-slate-400 hover:text-white' }}">EN</a>
                    <span class="text-slate-700">|</span>
                    <a href="{{ route('lang.switch', 'sw') }}" class="px-2 py-0.5 rounded transition text-xs {{ app()->getLocale() === 'sw' ? 'bg-[#c89a3b] text-[#0c1c34] font-extrabold' : 'text-slate-400 hover:text-white' }}">SW</a>
                </div>
            </div>
        </div>
    </div>
